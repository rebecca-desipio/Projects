...
class AreaChart {
    ...
    wrangleData() {
        ...
        let groupedData = d3.group(vis.data, d=>d.survey)
        console.log("grouped data: " + groupedData)

        let countConfig = d3.rollup(vis.data, groupedData=>groupedData.length, d=>d.survey)
        let arrayConfig = Array.from(countConfig, ([date, value]) => ({date, value}))

        // (2) Sort data by day
        vis.displayData = arrayConfig.sort((a,b)=>d3.ascending(a.date,b.date))
