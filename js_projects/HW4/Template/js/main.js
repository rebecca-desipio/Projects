...
function initMainPage(dataArray) {
    ...
    // TODO - init bars
    myBarVisOne = new BarVis('scatterDiv1', dataArray[1], dataArray[2], 1);
    myBarVisTwo = new BarVis('scatterDiv2', dataArray[1], dataArray[2], 0);

    document.getElementById("categorySelector").onchange = function() {
        myMapVis.wrangleData(this.value)
        myBarVisOne.wrangleData(this.value)
        myBarVisTwo.wrangleData(this.value)
    };
