...
class CountVis {
	...
	initVis() {
		...
		d3.select(".disp-dates").text('2012-11-29 ' + " ---> " + '2013-12-31');
	...
	updateVis(rangeStart, rangeEnd) {
		let vis = this;

		// Call brush component here
		// *** TO-DO ***
		vis.brushGroup.call(vis.brush, vis.zoom)
	...
	changeDates(rangeStart, rangeEnd) {
		let vis = this;

		d3.select(".disp-dates").text(dateFormatter(rangeStart) + " ---> " + dateFormatter(rangeEnd))
		vis.wrangleData();
	}
